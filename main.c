...
void quest(int nos,double data[3][2*nos]) // Based upon the input data, this function prints the components of the estimated quaternion//nos is number of stars
{	
